...
import { BrandVoiceFormData } from '@/types/icpAndBrandvoice';
...
import { WebsiteAnalysisDialog } from '../icp/WebsiteAnalysisDialog';
...
export function BrandVoiceForm({ initialData, onSubmit, onCancel }: BrandVoiceFormProps) {
    ...
    const handleScrapeWebsite = async () => {
        ...
        try {
            ...
            const data = await brandVoiceService.scrapeWebsite(websiteUrl);
    ...
    const handleEnhanceField = async (fieldName: string, content: string, characterLimit: number) => {
        ...
        try {
            ...
            const { enhancedContent } = await brandVoiceService.enhanceField(fieldName, content, characterLimit);
    ...
    const handleAnalyzeWebsite = async (url: string) => {
        ...
        try {
            setIsAnalyzing(true);
            const results = await brandVoiceService.analyzeWebsite(url);
                ...
                <div className="px-6 my-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Define your brand voice to help identify and target the right leads. This will be used to highlight your company and its offerings in generated emails.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
